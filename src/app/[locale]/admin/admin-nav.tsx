...
import { LayoutDashboard, LogOut, PlusCircle, Sparkles, HeartPulse, Inbox, Users, CalendarRange, Wallet, Contact, Images, ClipboardList, Mail } from 'lucide-react'
...
const navItems = [
  ...
  { label: 'Contactos', path: '/admin/leads', exact: false, Icon: Contact },
  { label: 'Días', path: '/admin/days', exact: false, Icon: CalendarRange },
  { label: 'Pagos', path: '/admin/payments', exact: false, Icon: Wallet },
  ...
  { label: 'Consolidado', path: '/admin/summary', exact: false, Icon: ClipboardList },
  { label: 'Solicitudes', path: '/admin/requests', exact: false, Icon: Inbox },
  { label: 'Imágenes', path: '/admin/media', exact: false, Icon: Images },
  { label: 'Correo', path: '/admin/email', exact: false, Icon: Mail },
]
